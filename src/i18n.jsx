...
const dict = {
  en: {
    ...
    "card.bm_creator": "CREATE BM & AD ACC",
    ...
    auth_signup_sub: "Pick a unique username: lowercase, numbers, underscores.",
    ...
    signup_success: "Signup successful. Please check email if verification is enabled.",
    signup_check_email: "Account created! Check your inbox and confirm your email to activate your account.",
  ...
  ar: {
    ...
    "card.bm_creator": "إنشاء BM وحسابات الإعلانات",
    ...
    auth_signup_sub: "اختر اسم مستخدم فريد: أحرف صغيرة وأرقام وشرطة سفلية.",
    ...
    signup_success: "تم إنشاء الحساب. يرجى التحقق من بريدك إذا كان التفعيل مفعّلًا.",
